...
describe('FriendsListScreen', () => {
  ...
  let getFriendsWithChatIdQueryMock: jest.MockedFunction<typeof api.friend.getFriendsWithChatIdFromUserId.useQuery>;
  ...
  beforeEach(() => {
    ...
    getFriendsWithChatIdQueryMock = api.friend.getFriendsWithChatIdFromUserId.useQuery as jest.MockedFunction<typeof api.friend.getFriendsWithChatIdFromUserId.useQuery>;
