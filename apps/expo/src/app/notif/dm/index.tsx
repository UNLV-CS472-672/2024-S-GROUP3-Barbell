...
const Chats = () => (
  <SafeAreaView>
    ...
    >
      <Text className="font-IstokWeb pb-1 pr-2 text-right text-[#FFFFFF]">Recieved</Text>
      <View style={styles.chats}>
        <Image source={require('~assets/buttons/Arrow40.png')} className=""></Image>
        <View>
          <Text className="font-IstokWeb px-4 pb-1  text-left text-[#FFFFFF]">John Doe</Text>
          <Text className="font-IstokWeb px-4 pb-1  text-left text-[#FFFFFF]">Last Message Recieved</Text>
        </View>
      </View>
    </TouchableOpacity>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.splitTop}>
        <TouchableOpacity className="mb-4 rounded-[18px] bg-[#FFFFFF] bg-cover px-8 py-2">
          <Text className="ml-1 mr-1 mt-1 flex-1 rounded-lg px-4 py-2 font-bold">Notifications</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity className="mb-4 rounded-[18px] bg-[#FFFFFF] px-12 py-2">
          <Text className="font-koulen text-center text-xl font-semibold ">Groups</Text>
        </TouchableOpacity>
      </View>
      <Separator />
      <Chats />
