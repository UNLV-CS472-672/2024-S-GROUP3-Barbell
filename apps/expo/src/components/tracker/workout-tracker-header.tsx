...
const WorkoutTrackerHeader: React.FC<IWorkoutTrackerHeaderProps> = ({ bottomSheetRef }) => {
    ...
    <View className="mx-2">
      <View className="mt-2 flex flex-row items-center justify-between">
        ...
        <View className="flex flex-row justify-end gap-x-4">
          ...
          <Button className="bg-light-green px-12">
            <Text className="font-bold text-white">Finish</Text>
          </Button>
        </View>
      </View>
      {/* TODO: Replace this text with an input component */}
      <Text className="font-koulen mt-6 text-3xl leading-tight tracking-widest text-slate-200">Afternoon Workout</Text>
